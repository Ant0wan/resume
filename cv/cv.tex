...
\hspace{6pt}\begin{minipage}[t]{0.98\textwidth} % 40% of the page width for the introduction text
	...
	{Hello, I am a DevOps Engineer working for the CIL's Infrastructure Team. I do my best to automate deployment and secure their systems. I am participating to the Linux Foundation Cloud Engineer Bootcamp.} % Dummy text
...
\begin{center}
	...
	\colorbox{black}{{\textcolor{white}{\textbf{\MakeUppercase{VMWare}}}}}
\end{center}
...
\begin{entrylist}
	\entry
		{11/2020 --\\04/2020\\\footnotesize{Fixed-term}}
		{DevOps Engineer}
		{CIL - Lamballe, France}
...
\begin{minipage}[t]{0.5\textwidth}
	...
	{C, Python, Git, Latex, Graphviz, RTC, Networks}
