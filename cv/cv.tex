...
\hspace{6pt}\begin{minipage}[t]{0.98\textwidth} % 40% of the page width for the introduction text
	...
	{Hello, I am a Platform Engineer with expertise in multi-cloud deployments, infrastructure automation, container orchestration, and CI/CD, leveraging technologies such as AWS, Azure, Kubernetes, Terraform, Ansible, Spinnaker, Python and Go.} % Dummy text
