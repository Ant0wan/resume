...
\hspace{6pt}\begin{minipage}[t]{0.98\textwidth} % 40% of the page width for the introduction text
	...
	{Hello, I am a DevOps working on GKE. I do my best to automate deployments and secure systems. I am participating to the Linux Foundation Cloud Engineer Bootcamp (LFCS+CKA).} % Dummy text
...
\begin{entrylist}
	\entry
		...
		{DevOps Engineer}
		{SII - Rennes, France}
		{Maintained 4GKE of ~5nodes with ~300 simultaneous users and their CI/CD for Brittany-Ferries.\\
