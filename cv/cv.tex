...
\hspace{6pt}\begin{minipage}[t]{0.98\textwidth} % 40% of the page width for the introduction text
	...
	{Hello, I am a Platform Engineer with 3 years of experience, specializing in multi-cloud deployments, infrastructure automation, container orchestration, and CI/CD. I have expertise in technologies such as AWS, Azure, Kubernetes, Terraform, Ansible, Spinnaker, Python, and Go.} % Dummy text
...
\begin{entrylist}
	\entry
		...
		\texttt{AWS}\slashsep\texttt{Azure}\slashsep\texttt{Go}\slashsep\texttt{Github Action}\slashsep\texttt{Python}\texttt{Jenkins}\slashsep\texttt{Terraform}\slashsep\texttt{Ansible}\slashsep\texttt{Spinnaker}\slashsep\texttt{Kubernetes}\slashsep\texttt{Vault}\slashsep\texttt{Helm}}
	\entry
...
\begin{minipage}[t]{0.5\textwidth}
	...
	{C, Rust, Haskell, Docker, VMWare, Git, Gitlab-CI, FluxCD, ArgoCD, Latex, Graphviz, Jira}
