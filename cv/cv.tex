...
\begin{entrylist}
	\entry
		{06/2021 --\\09/2021\\\footnotesize{Open-ended}}
		{DevOps Engineer}
		{SII - Rennes, France}
		{Maintained GCP Kubernetes clusters and their CI.\\
		\texttt{Kubernetes}\slashsep\texttt{GCP}\slashsep\texttt{Terraform}\slashsep\texttt{Gitlab}}
	\entry
