...
\hspace{0pt}\begin{minipage}[t]{1.00\textwidth}
	\vspace{-\baselineskip}
	{+4 years Site Reliability Engineer and developer with a strong background in deploying and managing cloud infrastructure using tools like Kubernetes, AWS, and Terraform. Passionate about optimizing system performance, enhancing CI/CD processes, and ensuring high availability in multi-cloud environments.}
\end{minipage}
\hfill
