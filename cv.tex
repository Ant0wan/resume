...
\hspace{0pt}\begin{minipage}[t]{0.99\textwidth} % 40% of the page width for the introduction text
	\vspace{-\baselineskip} % Required for vertically aligning minipages

	{Hello, I am a Platform Engineer with \textbf{+4 years} of experience in multi-cloud deployments, infrastructure automation, container orchestration, and CI/CD. I have expertise in technologies such as \textbf{AWS}, \textbf{Kubernetes}, \textbf{Terraform}, \textbf{Ansible}, \textbf{Python}, and \textbf{Go}.} % Dummy text
