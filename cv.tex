...
\DeclareRobustCommand{\octicons}{%
  \begingroup\normalfont
  \includegraphics[height=\fontcharht\font`\B]{img/octicons.png}%
  \endgroup
}
\DeclareRobustCommand{\linkedin}{%
  \begingroup\normalfont
  \includegraphics[height=\fontcharht\font`\B]{img/linkedin.png}%
  \endgroup
}
\DeclareRobustCommand{\gmail}{%
  \begingroup\normalfont
  \includegraphics[height=\fontcharht\font`\B]{img/gmail.png}%
  \endgroup
}
\DeclareRobustCommand{\web}{%
  \begingroup\normalfont
  \includegraphics[height=\fontcharht\font`\B]{img/web.png}%
  \endgroup
}
...
angle=0,
contents={%
  \includegraphics[width=\paperwidth,height=160pt]{img/federation_background.jpg}
  }%
}
...
\begin{center}
 \color{white} \bfseries \Huge Antoine Barthelemy\\[10pt]
  \Large42 student and Software Developer
\end{center}
\end{minipage}%
\begin{minipage}{.45\textwidth}
  \centering
\vspace{0.5cm}
  \roundpic[xshift=0cm,yshift=0cm]{3.7cm}{3.7cm}{img/profil.jpg}
\end{minipage}
}
\author{}
\date{}
...
\vskip 2mm%
\gmail{} marvin@42.fr | \octicons{} github.com/Ant0wan | \linkedin{} /in/Ant0wan | \web{} abarthel.dev/
\vskip 2mm%
{\color{lightgray}\hrule}
\end{center}
...
July.2020 --&{\bf Software Development Intern at CIL} - Lamballe, France\\
now&Intern in Infrastructure Team.\\
&Developed a ransomware detector for Synology NAS.\\[15pt]
