...
\begin{center}
 \color{white} \bfseries \Huge Antoine Barthelemy\\[10pt]
  \Large42 student looking for a 6-month Back-End Development internship
\end{center}
\end{minipage}%
...
&Drafted invitation to tender for a multinational - concerning its IT system redesign.\\[15pt]
Jul. --&{\bf Junior Modeler - Europe, Middle East \& Africa at CACIB}\\
Dec.2016&Took part in building Cash Flow models using Excel VBA to structure debts and performed sensitivity tests.\\[15pt]
Jan. --&{\bf Business Analyst / Assistant CEO at BrickVest}\\
...
&Ft\_ls - A tiny program that lists directory contents.\\
&Ft\_printf - A variadic function formatting output.\\
