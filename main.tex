...
\begin{minipage}[t]{0.28\textwidth} % 27.5% of the page width for the first row of icons
	...
	\icon{At}{12}{\href{mailto:abarthel@student.42.fr.me}{abarthel@student.42.fr}}\\
\end{minipage}
...
\begin{entrylist}
	\entry
		...
		{Software Developer}
		{CIL - Lamballe, France}
		{Gathered infrastructure team requierements and developed a deamon preventing ransomware and users from gamaging network attached storages.\\
