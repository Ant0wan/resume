...
\hspace{6pt}\begin{minipage}[t]{0.98\textwidth} % 40% of the page width for the introduction text
	...
	{Hello, I am a software developer working for the CIL's Infrastructure Team. I do my best to automate deployment and secure their systems. I feel best when I am coding, but I also found networking issues interesting to address.} % Dummy text
...
\begin{entrylist}
	\entry
		...
		{Software Developer}
		{CIL - Lamballe, France}
		{Developed a deamon preventing from ransomware and damaging user activities on network attached storage.\\
		\texttt{Rust}\slashsep\texttt{Linux}\slashsep\texttt{VMWare}\slashsep\texttt{Bash}\slashsep\texttt{Windows}}
	\entry
		{2017 -- 2018\\\footnotesize{Full Time}}
		{Digital Transformation Consultant}
		{Wavestone - Paris, France}
		{Performed testing of La Banque Postale's mobile and tablet application (Android, iOS and Windows Phone).\\Drafted invitation to tender for the IT system upgrade of a multinational company.\\ \texttt{Agile}\slashsep\texttt{RTC}}
	\entry
