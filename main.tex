...
\hspace{6pt}\begin{minipage}[t]{0.98\textwidth} % 40% of the page width for the introduction text
	...
	{Hello, I am a software developer working for the CIL's Infrastructure Team. I do my best to automate deployment and secure their systems.} % Dummy text
...
\begin{entrylist}
	\entry
		{7 -- 11/2020\\\footnotesize{Internship}}
		{Software Developer}
		{CIL - Lamballe, France}
		{Developed a deamon preventing from ransomware and damaging user activities.\\ \texttt{Rust}\slashsep\texttt{Linux}\slashsep\texttt{VMWare}}
	\entry
...
\begin{entrylist}
	\entry
		{Since 2018}
		{42\\\footnotesize{Certificate}}
		{Paris, France}
		{Hello blabla}
	\entry
		{2014 - 2017}
		{ESSEC\\\footnotesize{Bachelor of Business Administration}}
		{Cergy, France}
		{lkjdlaksjfa}
\end{entrylist}
